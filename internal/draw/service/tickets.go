...
func (s *drawService) CreateTickets(ctx context.Context, drawId int, num int) ([]*models.Ticket, error) {
	...
	tickets, err := lottery.CreateTickets(num, drawId)
	if err != nil {
...
func (s *drawService) ListTickets(ctx context.Context, drawId int) ([]*models.Ticket, error) {
...
func (s *drawService) GetTicket(ctx context.Context, ticketId int) (*models.Ticket, error) {
